...
model_id = '2019_ 4_08_13_50_24_631009'
model_id = '2019_ 4_08_22_11_31_429060'
model_id = '2019_ 4_09_17_56_20_332420'
model_id = '2019_ 4_09_17_57_46_142743'
model_id = '2019_ 4_09_17_55_53_626652'
exp_path = '/mnt/data/group07/johannes/ompc/ppexp_short6/' + cat + '_' + fold

data_lm_ft = TextLMDataBunch.load(Path('/mnt/data/group07/johannes/ompc/pplmexp_short6'))

if True or not Path('/mnt/data/group07/johannes/ompc/ppexp_short6/' + cat + '_' + fold +'/models/enc5.pth').is_file():
    ...
    os.makedirs(os.path.dirname('/mnt/data/group07/johannes/ompc/ppexp_short6/' + cat + '_' + fold +'/models/enc5.pth'), exist_ok=True)
    shutil.copy('/mnt/data/group07/johannes/ompc/pplmexp_short6/models/enc5.pth', '/mnt/data/group07/johannes/ompc/ppexp_short6/' + cat + '_' + fold +'/models/enc5.pth')


def run_for_class(it=1):
    train_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short6')/cat/fold/'train.pkl')
    test_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short6')/cat/fold/'test.pkl')
    ...
    drop_mult = 1.0
    exp_name = '6_2_bla__pp_' + cat + '_' + fold + '_' + str(drop_mult).replace('.', '_')
    ...
    def run_exp(exp_id, drop_mult, lr, factor, full_epochs):
        ...
        learn.callbacks += [
            ...
            EarlyStoppingCallback(learn, monitor='kappa_score', patience=40, mode='max'),
