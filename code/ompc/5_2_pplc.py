...
exp_path = '/mnt/data/group07/johannes/ompc/ppexp_short5/' + cat + '_' + fold

data_lm_ft = TextLMDataBunch.load(Path('/mnt/data/group07/johannes/ompc/pplmexp_short5'))

if True or not Path('/mnt/data/group07/johannes/ompc/ppexp_short5/' + cat + '_' + fold +'/models/enc5.pth').is_file():
    ...
    os.makedirs(os.path.dirname('/mnt/data/group07/johannes/ompc/ppexp_short5/' + cat + '_' + fold +'/models/enc5.pth'), exist_ok=True)
    shutil.copy('/mnt/data/group07/johannes/ompc/pplmexp_short5/models/enc5.pth', '/mnt/data/group07/johannes/ompc/ppexp_short5/' + cat + '_' + fold +'/models/enc5.pth')


def run_for_class(it=1):
    train_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short5')/cat/fold/'train.pkl')
    test_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short5')/cat/fold/'test.pkl')
    ...
    drop_mult = 0.8
    exp_name = '5pp_' + cat + '_' + fold + '_' + str(drop_mult).replace('.', '_')
