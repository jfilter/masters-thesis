...
data_lm_ft = TextLMDataBunch.load(Path('/mnt/data/group07/johannes/ompc/pplmexp_short2'))

if True or not Path('/mnt/data/group07/johannes/ompc/ppexp_short2/' + cat + '_' + fold +'/models/enc5.pth').is_file():
    ...
    os.makedirs(os.path.dirname('/mnt/data/group07/johannes/ompc/ppexp_short2/' + cat + '_' + fold +'/models/enc5.pth'), exist_ok=True)
    shutil.copy('/mnt/data/group07/johannes/ompc/pplmexp_short2/models/enc5.pth', '/mnt/data/group07/johannes/ompc/ppexp_short2/' + cat + '_' + fold +'/models/enc5.pth')
...
def run_for_class(it=1):
    ...
    drop_mult = 1.0
    exp_name = 'real_2pp_' + cat + '_' + fold + '_' + str(drop_mult).replace('.', '_')
