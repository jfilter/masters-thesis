...
exp_path = '/mnt/data/group07/johannes/ompc/ppexp_short2/' + cat + '_' + fold

data_lm_ft = TextLMDataBunch.load(Path('/mnt/data/group07/johannes/ompc/pplmexp_short3'))

if True or not Path('/mnt/data/group07/johannes/ompc/ppexp_short3/' + cat + '_' + fold +'/models/enc5.pth').is_file():
    ...
    os.makedirs(os.path.dirname('/mnt/data/group07/johannes/ompc/ppexp_short3/' + cat + '_' + fold +'/models/enc5.pth'), exist_ok=True)
    shutil.copy('/mnt/data/group07/johannes/ompc/pplmexp_short3/models/enc5.pth', '/mnt/data/group07/johannes/ompc/ppexp_short3/' + cat + '_' + fold +'/models/enc5.pth')


def run_for_class(it=1):
    train_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short3')/cat/fold/'train.pkl')
    test_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short3')/cat/fold/'test.pkl')
    ...
    drop_mult = 1
    exp_name = '3pp_' + cat + '_' + fold + '_' + str(drop_mult).replace('.', '_')
