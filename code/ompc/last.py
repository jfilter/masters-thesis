...
model_id = '2019_ 4_10_20_31_12_206165'
model_id = '2019_ 4_12_12_21_33_892632'
exp_path = '/mnt/data/group07/johannes/ompc/ppexp_short7/' + cat + '_' + fold

data_lm_ft = TextLMDataBunch.load(Path('/mnt/data/group07/johannes/ompc/pplmexp_short7'))

if True or not Path('/mnt/data/group07/johannes/ompc/ppexp_short7/' + cat + '_' + fold +'/models/enc5.pth').is_file():
    ...
    os.makedirs(os.path.dirname('/mnt/data/group07/johannes/ompc/ppexp_short7/' + cat + '_' + fold +'/models/enc5.pth'), exist_ok=True)
    shutil.copy('/mnt/data/group07/johannes/ompc/pplmexp_short7/models/enc5.pth', '/mnt/data/group07/johannes/ompc/ppexp_short7/' + cat + '_' + fold +'/models/enc5.pth')


def run_for_class(it=1):
    train_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short7')/cat/fold/'train.pkl')
    test_df = pd.read_pickle(Path('/mnt/data/group07/johannes/ompc/data_ann_pp_short7')/cat/fold/'test.pkl')
    ...
    drop_mult = 1.0
    exp_name = '7pp_' + cat + '_' + fold + '_' + str(drop_mult).replace('.', '_')
