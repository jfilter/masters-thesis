...
def to_file(df, cls, kind):
    ...
    out_p = f"/mnt/data/group07/johannes/ynacc_proc/fasttext_baseline/withreply/{cls}/"
...
for x in ['train.csv', 'test.csv']:
    df = pd.read_csv('/mnt/data/group07/johannes/ynacc_proc/replicate/split/' + x, usecols=['text', cls, 'parentid'])
