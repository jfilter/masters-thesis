...
EX_PA = Path('/mnt/data/group07/johannes/ompc/pplmexp_short5')

ex = Experiment('shortppompclm5')
ex.observers.append(MongoObserver.create(db_name='shortppompclm5'))
...
def my_config():
    bs=128
    epochs_start = 0 
    epochs= 3 #math.ceil(random.uniform(1, 3))
    drop_mult=0.75 #random.uniform(1, 2)
