...
def my_config():
    bs=128
    epochs_start = 0 
    epochs= 2 #math.ceil(random.uniform(1, 5))
    drop_mult= 0.8 #random.uniform(0.5, 1)
...
def my_main(epochs, drop_mult, exp_id, bs, epochs_start, model_id):    
    ...
    learn.load('2019_ 4_06_11_22_13_240007') 
    lr = 0.00001  #news_utils.fastai.get_optimal_lr(learn, runs=1)
    #lr = 0.001
